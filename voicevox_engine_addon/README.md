...
**English** | [日本語](https://github.com/taikun114/Home-Assistant-VOICEVOX-Engine/blob/main/docs/README-ja.md)
...
## Configuration
There are some configurations available for this add-on. Please refer to the [add-on documentation page](https://github.com/taikun114/Home-Assistant-VOICEVOX-Engine/blob/main/voicevox_engine_addon/DOCS.md) for more information about the add-on configuration.
